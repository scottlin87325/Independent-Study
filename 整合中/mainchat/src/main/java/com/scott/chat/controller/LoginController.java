...
public class LoginController {
	...
	public String showMessageBoard(@ModelAttribute Member member,
			Model model,HttpSession session) {
		member = memberService.findMemberByAccount(member.getEmail());
		model.addAttribute("member",member);
	    return "redirect:/messageborad/post/1/1"; 
	}
